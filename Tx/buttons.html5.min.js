(function(g) {
        ...
        g.each(b, function(b, c) {
            if (g.isPlainObject(c)) {
                ...
                if (v) {
                    ...
                    n.value = l[e].value, f.setAttributeNode(n);
                }
                f = y.serializeToString(c);
                v && (-1 === f.indexOf("<?xml") && (f = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + f), 
    ...
    function N(a, b) {
        ...
        for (var f = 0, e = a.body.length; f < e && !(c = a.body[f][b].toString().length, 
        c > d && (d = c), 40 < d); f++) ;
        return 5 < d ? d : 5;
    }
    ...
    if ("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) q = void 0; else {
        var w = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), O = "download" in w, G = /Version\/[\d\.]+.*Safari/.test(navigator.userAgent), z = h.webkitRequestFileSystem, H = h.requestFileSystem || z || h.mozRequestFileSystem, P = function(a) {
            ...
            if (O) e = (h.URL || h.webkitURL || h).createObjectURL(a), setTimeout(function() {
                ...
                h.chrome && (d && "application/octet-stream" !== d) && (s = a.slice || a.webkitSlice, 
                a = s.call(a, 0, a.size, "application/octet-stream"), f = !0);
        ...
        "undefined" !== typeof navigator && navigator.msSaveOrOpenBlob ? q = function(a, b, d) {
            ...
            C(this, "abort");
        }, k.readyState = k.INIT = 0, k.WRITING = 1, k.DONE = 2, k.error = k.onwritestart = k.onprogress = k.onwrite = k.onabort = k.onerror = k.onwriteend = null, 
        q = function(a, b, d) {
            return new J(a, b, d);
        });
    }
